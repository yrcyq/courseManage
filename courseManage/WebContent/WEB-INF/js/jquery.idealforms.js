...
$.idealforms.errors = {
  required: 'Required.',
  pass:'Must be 3 digits lowercase character and 6 digits numbers.',
  number: 'Must be numbers.',
  digits: 'Must be the unique number.',
  name: 'Character only. At least 1 characters',
  username: 'Must between 6-32 characters(.)',
  password: 'At least 6 digits.Must include 1 number, 1 lowercase and 1 uppercase character.',
...
var getFilters = function() {
  ...
  var filters = {
    ...
    password: {
      regex: /(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}/,
      error: $.idealforms.errors.password
    },
    ...
    Telephone: {
      ...
      error: $.idealforms.errors.Telephone
    },
